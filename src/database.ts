...
export interface IDatabase {
  ...
  getNotesByText(search: string): INote[],
  getNotes(): INote[],
  getNoteById(noteId: string): INote,
  storeNote(title: string, content: string): void,
...
export class Database implements IDatabase {
  ...
  getNoteById(noteId: string): INote {
    return this.notes.find((note: INote) => note.id === noteId);
  }
