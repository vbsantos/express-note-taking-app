...
export class Database implements IDatabase {
  ...
  async updateNote(noteId: string, title: string, content: string): Promise<string> {
  ...
  async getNoteById(noteId: string): Promise<INote> {
    return this.notes.find((note: INote) => note._id === noteId);
  }
